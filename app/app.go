...
import (
	...
	"github.com/raneet10/requestmoney/x/requestmoney"
	requestmoneykeeper "github.com/raneet10/requestmoney/x/requestmoney/keeper"
	requestmoneytypes "github.com/raneet10/requestmoney/x/requestmoney/types"
  // this line is used by starport scaffolding # 1
)

const appName = "requestmoney"

var (
	DefaultCLIHome = os.ExpandEnv("$HOME/.requestmoneycli")
	DefaultNodeHome = os.ExpandEnv("$HOME/.requestmoneyd")
...
func NewInitApp(
  ...
  // this line is used by starport scaffolding # 4
	...
	app.mm = module.NewManager(
		...
		requestmoney.NewAppModule(app.requestmoneyKeeper, app.bankKeeper),
